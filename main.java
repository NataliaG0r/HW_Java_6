...
public class Main {
    public static void main(String[] args) {
        ...
        ноутбуки.add(new Ноутбук("Модель 1", 8, 512, "Windows", "Серый"));
        ноутбуки.add(new Ноутбук("Модель 2", 16, 1024, "MacOS", "Серебристый"));
        ноутбуки.add(new Ноутбук("Модель 3", 8, 256, "Linux", "Черный"));
        ...
        Set<Ноутбук> результаты = Ноутбук.фильтроватьНоутбуки(ноутбуки, критерии);
